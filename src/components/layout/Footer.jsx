...
const Footer = () => {
  return (
    <footer className="bg-[#1a1a24] text-gray-300">
        ...
        <div>
          ...
          <div className="max-w-md mx-auto mb-8">
            ...
            <div className="flex justify-center space-x-5">
              ...
              <a href="https://www.instagram.com/alvira.insta/" className="text-gray-400 hover:text-[#d4b78f] transition-colors duration-300" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://www.youtube.com/@Alviraimpressionz" className="text-gray-400 hover:text-[#d4b78f] transition-colors duration-300" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="https://api.whatsapp.com/send/?phone=919985852000&text&type=phone_number&app_absent=0&wame_ctl=1" className="text-gray-400 hover:text-[#d4b78f] transition-colors duration-300" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
